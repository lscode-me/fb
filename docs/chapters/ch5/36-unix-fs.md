...
ext3 (2001, Stephen Tweedie) решила главную боль ext2 — длительное восстановление после сбоя. Вместо проверки всего диска достаточно «проиграть» журнал — лог недавних операций. Восстановление занимает **секунды** вместо минут.
