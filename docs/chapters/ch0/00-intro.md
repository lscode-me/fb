...
Эта книга — **missing manual** про файлы: одновременно **руководство** для последовательного изучения и **энциклопедия-справочник**, к которой удобно возвращаться за деталями. Мы заполним пробелы и построим **целостное понимание** файлов на пяти уровнях:
...
!!! tip "Как читать"
    Книга задумана так, чтобы работать и как учебник, и как справочник. Главы можно читать последовательно для погружения в тему или выборочно — как энциклопедию, заглядывая в нужный раздел по мере необходимости. Если вас интересуют конкретные темы:
